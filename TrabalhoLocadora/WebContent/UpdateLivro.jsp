...
<html>
    ...
    <body>
		...
		<form class="row g-3 needs-validation" method="post" action="update-livro" novalidate>
			<div class="col-md-4">
				<label for="nomeLivro" class="form-label">Nome:</label>
				<input type="text" class="form-control" id="nomeLivro" name="nome-livro" value="<%= l.getNomeLivro() %>" required>
			</div>
			
			<div class="col-md-4">
				<label for="autorLivro" class="form-label">Email:</label>
				<input type="" class="form-control" id="autorLivro" name="autor-livro" value="<%= l.getAutor() %>" required>
			</div>
