...
<html>
    ...
    <body>
        ...
        <h1>Atualizar Usuario</h1>
        	...
        	<% String erro = (String) request.getAttribute("erro-findUser"); %>
		
			<% if(erro != null){ %>
			<p><% out.println(erro); %></p>
			<% } %>

	        <form class="row g-3 needs-validation" method="post" action="find-user" novalidate>
				<div class="col-md-4">
					<label for="idUsuario" class="form-label">Digite o Id do usuario que deseja alterar:</label>
					<input type="text" class="form-control" id="idUsuario" name="id-usuario" required>
				</div>
