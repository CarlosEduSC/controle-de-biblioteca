...
<html>
	...
	<body>
		...
		<form class="row g-3 needs-validation" novalidate method="post" action="cadastro-usuario">
			<div class="col-md-4">
				<label for="nomeUsuario" class="form-label">Nome:</label>
				<input type="text" class="form-control" id="nomeUsuario" name="nome-usuario" required>
			</div>
			
			<div class="col-md-4">
				<label for="emailUsuario" class="form-label">Email:</label>
				<input type="email" class="form-control" id="emailUsuario" name="email-usuario" required>
			</div>

			<div class="col-md-6">
				<label for="senhaUsuario" class="form-label">Senha:</label>
				<input type="password" class="form-control" id="senhaUsuario" name="senha-usuario" required>
			</div>
			...
			<div class="col-md-3">
				...
				<select class="form-select" id="tipoUsuario" name="tipo-usuario" required>
					...
					<option vaue="Aluno">Aluno</option>
				</select>
			</div>
